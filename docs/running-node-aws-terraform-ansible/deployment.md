...
#### 2.1.2 (For non-genesis validator nodes) Configure genesis data
...
#### 2.1.3 Persistent peers configuration
...
##### if `Private Sentries` are disabled



##### if `Private Sentries` are enabled
